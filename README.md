...
Si hasta ahora seguís sin resolver tu duda, [**creá un nuevo issue**](https://github.com/dds-jv/foro/discussions/new) usando el botón verde de `New`. Escribí un título descriptivo para tu pregunta, y explayate en el mensaje contando todos los detalles necesarios. 
